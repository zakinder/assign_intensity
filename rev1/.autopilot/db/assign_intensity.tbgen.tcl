...
set C_modelArgList {
	...
	{ node_output int 32 regular {array 16 { 2 3 } 1 1 }  }
	{ node_count int 32 regular {array 16 { 2 3 } 1 1 }  }
}
...
set portList { 
	...
	{ node_output_we0 sc_out sc_logic 1 signal 2 } 
	{ node_output_d0 sc_out sc_lv 32 signal 2 } 
	...
	{ node_count_we0 sc_out sc_logic 1 signal 3 } 
	{ node_count_d0 sc_out sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "node_output_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "node_output", "role": "we0" }} , 
 	{ "name": "node_output_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "node_output", "role": "d0" }} , 
 	...
 	{ "name": "node_count_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "node_count", "role": "we0" }} , 
 	{ "name": "node_count_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "node_count", "role": "d0" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"], "CDFG" : "assign_intensity", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
	...
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.assign_intensity_fdiv_32ns_32ns_32_16_U2", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.assign_intensity_uitofp_64ns_32_6_U3", "Parent" : "0", "Child" : []},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "260", "Max" : "294"}
	, {"Name" : "Interval", "Min" : "261", "Max" : "295"}
]}
...
set Spec2ImplPortList { 
	...
	node_output { ap_memory {  { node_output_address0 mem_address 1 4 }  { node_output_ce0 mem_ce 1 1 }  { node_output_we0 mem_we 1 1 }  { node_output_d0 mem_din 1 32 }  { node_output_q0 mem_dout 0 32 } } }
	node_count { ap_memory {  { node_count_address0 mem_address 1 4 }  { node_count_ce0 mem_ce 1 1 }  { node_count_we0 mem_we 1 1 }  { node_count_d0 mem_din 1 32 }  { node_count_q0 mem_dout 0 32 } } }
}
