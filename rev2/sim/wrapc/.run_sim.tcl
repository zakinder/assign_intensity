...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "assign_intensity.autotvin.dat"
	set constFileTvOut       "assign_intensity.autotvout.dat"
	set constFileHdlTvIn     "assign_intensity.autohdltvin.dat"
	set constFileHdlTvOut    "assign_intensity.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
