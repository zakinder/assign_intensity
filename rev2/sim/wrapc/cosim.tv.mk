...
$(ObjDir)/assign_intensity_tb.cpp_pre.cpp.tb.o : assign_intensity_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling assign_intensity_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/assign_intensity.cpp_pre.cpp.tb.o : assign_intensity.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling assign_intensity.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
