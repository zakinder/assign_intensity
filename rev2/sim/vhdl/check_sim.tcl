...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.assign_intensity.autotvin_alphabuf.dat"
         "c.assign_intensity.autotvin_intensity.dat"
         "c.assign_intensity.autotvin_node_output.dat"
         "c.assign_intensity.autotvin_node_count.dat"
         "c.assign_intensity.autotvout_node_output.dat"
         "c.assign_intensity.autotvout_node_count.dat"
         "c.assign_intensity.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.assign_intensity.autotvout_node_output.dat"
         "rtl.assign_intensity.autotvout_node_count.dat"
         "rtl.assign_intensity.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
