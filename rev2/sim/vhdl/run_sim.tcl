...
if {[file isfile assign_intensity.autotvin.dat]} {
	file delete -force assign_intensity.autotvin.dat
}

if {[file isfile assign_intensity.autotvout.dat]} {
	file delete -force assign_intensity.autotvout.dat
}
